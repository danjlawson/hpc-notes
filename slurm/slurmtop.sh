...
function help {
    echo "stop.sh : access the PBS queue in a convenient way.
Behaves as \"top\" for the SLURM queue, querying \"squeue\" periodically.
...
-u <val> : query squeue for user <val> (default: $USER)
